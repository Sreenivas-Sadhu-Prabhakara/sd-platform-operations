package com.bank.bian.platformoperations.model;
...
/**
 * The BIAN control record for this service domain: "Platform Service Operating Session".
 *
 ...
 * to its asset type (Platform Service). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Platform Service Operating Session";
